...
'''
client = pymongo.MongoClient("mongodb+srv://stockbroker:Stockbroker101@cluster0.fk5y5.mongodb.net/Cluster0?retryWrites=true&w=majority")
DATABASES = client['cluster0']
'''
